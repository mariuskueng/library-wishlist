...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Branch'
        db.create_table(u'library_wishlist_branch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('adress', self.gf('django.db.models.fields.TextField')()),
            ('opening_hours', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'library_wishlist', ['Branch'])


    def backwards(self, orm):
        # Deleting model 'Branch'
        db.delete_table(u'library_wishlist_branch')
