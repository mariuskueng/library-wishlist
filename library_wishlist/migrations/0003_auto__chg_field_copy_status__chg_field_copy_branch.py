...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'library_wishlist_copy', 'branch', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Copy.status'
        db.alter_column(u'library_wishlist_copy', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Copy.branch'
        db.alter_column(u'library_wishlist_copy', 'branch', self.gf('django.db.models.fields.IntegerField')())
