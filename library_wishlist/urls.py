...
from library_wishlist.views import IndexView, BranchView, createItem, completeItem, createSearchResultItem
...
urlpatterns = patterns('',
    ...
    url(r'^itemSearchResult/$', createSearchResultItem, name='new_item'),
